...
$(function () {
    ...
    $.get(url, function (ok) {
        console.dir(ok)
        $("#buss").val(ok.buss.bussNavn); // må ha med id inn skjemaet, hidden i html
        $("#avg1").val(ok.rute.avganger[0].stopp.stasjonNavn);
        $("#avg2").val(ok.rute.avganger[1].stopp.stasjonNavn);
        $("#avg3").val(ok.rute.avganger[2].stopp.stasjonNavn);
        $("#avg4").val(ok.rute.avganger[3].stopp.stasjonNavn);
        $("#avg5").val(ok.rute.avganger[4].stopp.stasjonNavn);
        $("#avg6").val(ok.rute.avganger[5].stopp.stasjonNavn);
        $("#pris").val(ok.rute.pris);

        // id'ene 
        
        $("#bussruteid").val(ok.buss_RuteId); // må ha med id inn skjemaet, hidden i html
        $("#bussid").val(ok.buss.bussId); // må ha med id inn skjemaet, hidden i html
        $("#avg1Id").val(ok.rute.avganger[0].stopp.stasjonId);
        $("#avg2Id").val(ok.rute.avganger[1].stopp.stasjonId);
        $("#avg3Id").val(ok.rute.avganger[2].stopp.stasjonId);
        $("#avg4Id").val(ok.rute.avganger[3].stopp.stasjonId);
        $("#avg5Id").val(ok.rute.avganger[4].stopp.stasjonId);
        $("#avg6Id").val(ok.rute.avganger[5].stopp.stasjonId);
        $("#ruteId").val(ok.rute.ruteId);

        // Avgang ide'ene for å lagre nye avgangstider
        $("#avganger1").val(ok.rute.avganger[0].stoppId);
        $("#avganger2").val(ok.rute.avganger[1].stoppId);
        $("#avganger3").val(ok.rute.avganger[2].stoppId);
        $("#avganger4").val(ok.rute.avganger[3].stoppId);
        $("#avganger5").val(ok.rute.avganger[4].stoppId);
        $("#avganger6").val(ok.rute.avganger[5].stoppId);




        for (let tid of ok.rute.avganger[0].tider) {
            $("#tid1").append(tid.tid+"<br/>");
            console.log(tid.tid);
        }
        for (let tid of ok.rute.avganger[1].tider) {
            $("#tid2").append(tid.tid + "<br/>");
            console.log(tid.tid);
        }
        for (let tid of ok.rute.avganger[2].tider) {
            $("#tid3").append(tid.tid + "<br/>");
            console.log(tid.tid);
        }
        for (let tid of ok.rute.avganger[3].tider) {
            $("#tid4").append(tid.tid + "<br/>");
            console.log(tid.tid);
        }
        for (let tid of ok.rute.avganger[4].tider) {
            $("#tid5").append(tid.tid + "<br/>");
            console.log(tid.tid);
        }
        for (let tid of ok.rute.avganger[5].tider) {
