...
function hentAlleStrekninger() {
    ...
    $.get("billett/HentAlleRuter", function (bussruter) {
        ...
        for (let bussrute of bussruter) {
            ...
            ut += "<td class='align-middle' > <a class='btn btn-primary w-50 m-1' href='endre.html?id=" + bussrute.buss_RuteId + "'><i class='fa fa-edit'></i></a> ";
            ut += " <button type='button' class='btn btn-danger w-50 m-1 ' onClick='slett(" + bussrute.buss_RuteId + ")'><i class='fa fa-trash'></i></button></td>";
